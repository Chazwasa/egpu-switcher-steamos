...
```bash
curl -sL https://github.com/Chazwasa/egpu-switcher-steamos/raw/main/egpu-switcher.sh -o ~/Desktop/egpu-switcher.sh && chmod +x ~/Desktop/egpu-switcher.sh && bash ~/Desktop/egpu-switcher.sh
```
